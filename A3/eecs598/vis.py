...
def tensor_to_image(tensor):
    ...
    """
    tensor = \
        tensor.mul(255).add_(0.5).clamp_(0, 255).permute(1, 2, 0)
...
def detection_visualizer(img, idx_to_class, bbox=None, pred=None):
    ...
    if cv2 is None:
        raise ModuleNotFoundError(
            "OpenCV is required for detection_visualizer. Install opencv-python "
            "or skip this optional visualization cell."
        )
