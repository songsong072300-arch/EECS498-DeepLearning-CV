...
def preprocess_cifar10(
    ...
    # Move data to the GPU when available; otherwise keep it on CPU so local
    # VS Code runs do not fail on machines without CUDA.
    if cuda and torch.cuda.is_available():
        ...
        print("CUDA requested but not available; using CPU tensors instead.")
